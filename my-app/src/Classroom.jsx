      ...
      <div className="Content">
        ...
        <div className="Section">
          ...
          <ul className="BulletPoints">
            ...
            <li>Developing empathy towards the students and learning about their personal stories can help educators build relationships with all their students regardless of their social identities. </li>
            <li>If a student shares something about their culture or corrects a professor or teacher on something you said about the culture they come from, the professor or teacher should at the very least acknowledge what the student shared. </li>
            <li>Having professors and teachers learn about norms in different cultures can greatly improve their interactions with multicultural students. </li>
